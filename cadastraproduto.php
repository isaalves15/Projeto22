...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    // Três iguais ===, servem para verificar se dois itens são identicos até no tipo de dados
    ...
    while($tbl = mysqli_fetch_array($retorno)){
        ...
        // Verifica se o produto existe, se sim, informa, se nã insere
        if($cont == 1){
