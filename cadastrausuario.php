...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($cont == 1){
        ...
        $sql = "INSERT INTO usuarios (usu_nome, usu_senha, usu_ativo) #O USUÁRIO VAI ENTRAR NO BANCO COMO INATIVO PRIMEIRAMENTE.
        VALUES ('$nome','$senha','n')";
        mysqli_query($link, $sql);
        #CADASTRA USUÁRIO E JOGA MENSAGEM NA TELA E DIRECIONA PARA LISTA USUÁRIO
